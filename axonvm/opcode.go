...
const (
	...
	OpJSMemberGet              // [OpCode, NameConstIdxHigh, NameConstIdxLow, ICNodeIDHigh, ICNodeIDLow]
	OpJSMemberSet              // [OpCode, NameConstIdxHigh, NameConstIdxLow, ICNodeIDHigh, ICNodeIDLow]
